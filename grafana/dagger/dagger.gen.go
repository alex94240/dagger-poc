...
import (
	...
	"dagger/grafana/internal/telemetry"
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Grafana":
		...
		case "ContainerEcho":
			...
			return (*Grafana).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Grafana
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
